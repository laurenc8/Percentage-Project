...
<Viz />
<Dots width = {window.innerWidth > 720 ? 720 : window.innerWidth * 0.9} height={window.innerHeight/3} />
...
<LineGraph2 width = {window.innerWidth > 720 ? 720 : window.innerWidth * 0.9 } height = {(window.innerWidth > 720 ? 720 : window.innerWidth * 0.9 )*3/4.5}> </LineGraph2> 
</div>
